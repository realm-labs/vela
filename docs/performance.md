...
cache-enabled stdlib, script/native call, method-dispatch, collection lookup/combination, Option/Result helper, callback collection, and host-boundary rows with warmed inline caches and bytecode profile counters
...
collection lookup/combination, Option/Result helper, callback collection, and
