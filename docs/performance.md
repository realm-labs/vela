...
cache-enabled stdlib, script/native call, method-dispatch, array/map lookup, callback collection, and host-boundary rows with warmed inline caches and bytecode profile counters
...
array/map lookup, callback collection, and direct-closure rows with warmed
