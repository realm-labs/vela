...
- Continue the M20.5 native LSP capability track by broadening Phase 4
  diagnostics: add analysis and schema diagnostics to the editor-neutral
  diagnostic model, report stale-generation status explicitly, and keep
  incomplete LSP capabilities unadvertised.
