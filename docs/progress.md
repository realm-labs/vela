...
participate in `textDocument/references` for declarations and typed host
receiver call sites; trait methods and broader schema call hierarchy remain
open.
