...
- M19: continue optimizing the non-JIT interpreter and managed heap path only
  ...
  overhead, broader scalar dispatch measurements, and gameplay-host benchmark
  deltas.
...
- Choose the next narrow measured M19 optimization target from the updated
  ...
  conversion, string/heap-mode callback call overhead, and broader scalar
