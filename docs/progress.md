...
- Continue the M20.5 native LSP capability track with `vela.toml`/workspace
  file ingestion, cancellation, progress, and later incremental document sync
  while keeping incomplete capabilities unadvertised.
