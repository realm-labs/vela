...
calls. Source-owned inherent and trait impl script methods also participate in
...
receiver call sites; trait default/interface method call hierarchy and broader
schema call hierarchy remain open.
