...
Code action, inlay hint, semantic token, and formatting compatibility paths
now serialize typed `lsp/to_proto.rs` projections instead of keeping duplicate
raw response encoders.
