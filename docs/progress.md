...
receiver call sites. Schema-backed methods and trait methods with source spans
now participate in `textDocument/prepareCallHierarchy`, incoming calls, and
script-caller outgoing calls for typed receiver call sites.
