...
| M16 | Partial | Parser, semantic, runtime/call-stack, host, reflection, hot reload, and completion snapshot fixtures exist; TypeFact and flow-narrowing fixtures remain. |
...
- M16/M17: add TypeFact and flow-narrowing diagnostic fixtures, then expand
  game-server demo coverage around the stable embedding and reload surface.
...
- Broaden M16/M17 TypeFact, flow-narrowing, conformance, and game-server demo
