...
- Continue the M20.5 native LSP capability track with workspace folder changes,
  cancellation, progress, and later incremental document sync while keeping
