...
impl<F, A, B, C, D, R> TypedHostNativeFunction<(A, B, C, D)> for F
where
    F: for<'host> Fn(&mut HostExecution<'host>, A, B, C, D) -> R + Send + Sync + 'static,
    A: FromScriptArg,
    B: FromScriptArg,
    C: FromScriptArg,
    D: FromScriptArg,
...
impl<F, A, B, C, D, E, R> TypedHostNativeFunction<(A, B, C, D, E)> for F
where
    F: for<'host> Fn(&mut HostExecution<'host>, A, B, C, D, E) -> R + Send + Sync + 'static,
    A: FromScriptArg,
    B: FromScriptArg,
    C: FromScriptArg,
    D: FromScriptArg,
...
impl<F, A, B, C, D, E, G, R> TypedHostNativeFunction<(A, B, C, D, E, G)> for F
where
    F: for<'host> Fn(&mut HostExecution<'host>, A, B, C, D, E, G) -> R + Send + Sync + 'static,
    A: FromScriptArg,
    B: FromScriptArg,
    C: FromScriptArg,
    D: FromScriptArg,
