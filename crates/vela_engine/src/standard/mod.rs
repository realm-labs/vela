...
pub use ids::{
    ...
    STRING_SLICE_METHOD_ID, STRING_STARTS_WITH_METHOD_ID, STRING_STRIP_PREFIX_METHOD_ID,
    STRING_STRIP_SUFFIX_METHOD_ID, STRING_TO_LOWER_METHOD_ID, STRING_TO_UPPER_METHOD_ID,
    STRING_TRIM_END_METHOD_ID, STRING_TRIM_METHOD_ID, STRING_TRIM_START_METHOD_ID, STRING_TYPE_ID,
};
