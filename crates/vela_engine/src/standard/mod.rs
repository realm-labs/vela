...
pub use ids::{
    ...
    SET_REMOVE_METHOD_ID, SET_TYPE_ID, STRING_CONTAINS_METHOD_ID, STRING_ENDS_WITH_METHOD_ID,
    STRING_IS_EMPTY_METHOD_ID, STRING_LEN_METHOD_ID, STRING_REPEAT_METHOD_ID,
    STRING_REPLACE_METHOD_ID, STRING_SLICE_METHOD_ID, STRING_STARTS_WITH_METHOD_ID,
    STRING_TO_LOWER_METHOD_ID, STRING_TO_UPPER_METHOD_ID, STRING_TRIM_END_METHOD_ID,
    STRING_TRIM_METHOD_ID, STRING_TRIM_START_METHOD_ID, STRING_TYPE_ID,
};
