...
mod tests {
    ...
    fn registered_rust_primitives_round_trip_through_vela_behavior() {
        let engine = Engine::builder()
            ...
            .install_type_binding::<String>(standard_type_binding::<String>())
            .build()
...
"#,
    ...
    fn tuple_bindings_preserve_arity_order_and_compiler_facts() {
        ...
        let engine = Engine::builder()
            .install_type_binding::<Pair>(standard_type_binding::<Pair>())
            .build()
    ...
    fn registered_rust_tuples_round_trip_through_vela_projections() {
        ...
        let engine = Engine::builder()
            .with_standard_natives()
            .install_type_binding::<Pair>(standard_type_binding::<Pair>())
            .install_type_binding::<Reversed>(standard_type_binding::<Reversed>())
            .build()
...
"#,
    ...
    fn engine_seal_rejects_a_forged_callable_binding_representation() {
        ...
        let result = Engine::builder()
            .install_type_binding::<Vec<i64>>(binding)
    ...
    fn collection_view_capabilities_keep_one_identity_across_registry_views() {
        ...
        let engine = Engine::builder()
            .install_type_binding::<Scores>(standard_type_binding::<Scores>())
            .build()
    ...
    fn registered_rust_option_and_result_values_use_vela_behavior() {
        ...
        let engine = Engine::builder()
            .with_standard_natives()
            .install_type_binding::<MaybeScore>(standard_type_binding::<MaybeScore>())
            .install_type_binding::<ScoreResult>(standard_type_binding::<ScoreResult>())
            .build()
...
"#,
    ...
    fn registered_rust_maps_share_vela_map_behavior_and_keep_distinct_abi() {
        ...
        let engine = Engine::builder()
            .with_standard_natives()
            .install_type_binding::<OrderedScores>(standard_type_binding::<OrderedScores>())
            .install_type_binding::<HashedScores>(standard_type_binding::<HashedScores>())
            .build()
...
"#,
    ...
    fn registered_vec_and_set_values_use_shared_vela_collection_behavior() {
        ...
        let engine = Engine::builder()
            .with_standard_natives()
            .install_type_binding::<Values>(standard_type_binding::<Values>())
            .install_type_binding::<Bytes>(standard_type_binding::<Bytes>())
            .install_type_binding::<Ordered>(standard_type_binding::<Ordered>())
            .install_type_binding::<Hashed>(standard_type_binding::<Hashed>())
            .build()
