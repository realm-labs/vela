...
fn unified_type_binding_is_sealed_into_engine_and_reflection_registry() {
    ...
    let engine = Engine::builder()
        .install_type_binding::<ExternalHost>(
        ...
        .install_type_binding::<ExternalValue>(external_value_binding(value_desc(102, "amount")))
        .build()
...
fn type_binding_fingerprint_ignores_docs_but_tracks_structural_abi() {
    let first = Engine::builder()
        .install_type_binding::<ExternalValue>(external_value_binding(
    ...
    let changed = Engine::builder()
        .install_type_binding::<ExternalValue>(external_value_binding(value_desc(102, "total")))
        .build()
...
fn collection_view_kind_must_match_the_bound_representation() {
    let result = Engine::builder()
        .install_type_binding::<ExternalValue>(
...
fn bytes_binding_accepts_array_view_capabilities() {
    ...
    Engine::builder()
        .install_type_binding::<Vec<u8>>(binding)
        .build()
...
fn type_binding_rejects_ambiguous_storage_and_receiver_capabilities() {
    let value_with_host_storage = Engine::builder()
        .install_type_binding::<ExternalValue>(external_value_binding(host_desc(101, 201)))
        .build();
    assert!(matches!(
