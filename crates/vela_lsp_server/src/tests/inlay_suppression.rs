...
#[test]
fn lsp_inlay_hints_suppress_any_schema_method_parameters_on_schema_method_return_receiver() {
    let root = temp_workspace();
    let config_path = root.join("vela.toml");
    let schema_path = root.join("target").join("vela").join("schema.json");
    fs::create_dir_all(schema_path.parent().expect("schema should have parent"))
...
#[test]
fn lsp_inlay_hints_suppress_any_schema_trait_method_parameters_on_schema_method_return_receiver() {
    let root = temp_workspace();
    let config_path = root.join("vela.toml");
    let schema_path = root.join("target").join("vela").join("schema.json");
    fs::create_dir_all(schema_path.parent().expect("schema should have parent"))
