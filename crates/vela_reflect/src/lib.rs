...
pub use members::{
    ...
    field_with_policy as field_metadata_with_policy, has_attr as has_attr_metadata, has_field,
    ...
    name as name_metadata, required_permissions as required_permissions_metadata,
