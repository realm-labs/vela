...
fn mir_builder_expected_option_try_is_explicit_cfg() {
    ...
    assert_eq!(
        ...
        r#"mir {
  target function#9200 CompileFunctionDescriptor { id: FunctionId(9200), class: Script, canonical_symbol: "try_builder::main", debug_name: "main", signature: CompileSignature { asyncness: Sync, parameters: [CompileParameter { name: "value", contract: None, default: Required, origin: Some(MirSourceOrigin { body: Some(HirBodyId(0)), node: Body(HirBodyId(0)), span: Span { source: SourceId(92), start: 8, end: 13 } }) }], positional: ExactOrTrailingDefaults, return_contract: None, effect: MirEffect { may_trap: false, may_allocate: false, script_call: false, dynamic_call: false, state_read: false, state_write: false, host_read: false, host_write: false, host_call: false, reflection_read: false, reflection_write: false, reflection_call: false, emits_event: false, reads_time: false, uses_random: false, reads_io: false, writes_io: false, task_spawn: false } }, access: CompileFunctionAccess { public: false, reflect_visible: true, reflect_callable: false } }
