...
fn assignment_builder_lowers_typed_local_compound_and_returns_the_result() {
    ...
    assert_eq!(
        program.dump(),
        r#"mir {
  target function#8200 CompileFunctionDescriptor { id: FunctionId(8200), class: Script, canonical_symbol: "assignments::main", debug_name: "main", signature: CompileSignature { asyncness: Sync, parameters: [CompileParameter { name: "value", contract: None, default: Required, origin: None }], positional: ExactOrTrailingDefaults, return_contract: None, effect: MirEffect { may_trap: false, may_allocate: false, script_call: false, dynamic_call: false, state_read: false, state_write: false, host_read: false, host_write: false, host_call: false, reflection_read: false, reflection_write: false, reflection_call: false, emits_event: false, reads_time: false, uses_random: false, reads_io: false, writes_io: false, task_spawn: false } }, access: CompileFunctionAccess { public: false, reflect_visible: true, reflect_callable: false } }
