...
fn tuple_assignment_rebuilds_a_direct_local_and_returns_the_leaf() {
    ...
    assert_eq!(
        program.dump(),
        r#"mir {
  target function#9400 CompileFunctionDescriptor { id: FunctionId(9400), class: Script, canonical_symbol: "tuple_assignments::main", debug_name: "main", signature: CompileSignature { asyncness: Sync, parameters: [CompileParameter { name: "pair", contract: None, default: Required, origin: None }, CompileParameter { name: "rhs", contract: None, default: Required, origin: None }], positional: ExactOrTrailingDefaults, return_contract: None, effect: MirEffect { may_trap: false, may_allocate: false, script_call: false, dynamic_call: false, state_read: false, state_write: false, host_read: false, host_write: false, host_call: false, reflection_read: false, reflection_write: false, reflection_call: false, emits_event: false, reads_time: false, uses_random: false, reads_io: false, writes_io: false, task_spawn: false } }, access: CompileFunctionAccess { public: false, reflect_visible: true, reflect_callable: false } }
