...
"#;
    ...
    let mismatched_arms = return_match_arm_payloads(&cst_payload.body);
    let legacy_match =
    ...
    let err = compiler
        .compile_match_value_with_payloads(legacy_match, Register(0), None, &mismatched_arms)
...
"#;
    ...
    let missing_guard_arms = return_match_arm_payloads(&cst_payload.body);
    let missing_guard = &missing_guard_arms[0];
    assert!(
        missing_guard
            .syntax_arm()
    ...
    let err = compiler
        .compile_match_value_with_payloads(legacy_match, Register(0), None, &missing_guard_arms)
...
fn return_match_arm_payloads(
    body: &body_payloads::CompilerBodyPayload<'_>,
) -> Vec<body_payloads::CompilerMatchArmPayload> {
