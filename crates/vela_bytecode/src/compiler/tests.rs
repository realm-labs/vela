...
fn assert_cst_assignment_values(
    body: &body_payloads::CompilerBodyPayload<'_>,
    expected: &[(SyntaxExpressionKind, &str)],
) {
    let statements = body.statement_payloads();
    let actual = statements
        ...
        .filter_map(|statement| {
            let syntax = statement.syntax_statement()?;
            let value = syntax.as_expr()?.expression()?.as_assign()?.value()?;
...
fn assert_cst_call_argument_values(
    body: &body_payloads::CompilerBodyPayload<'_>,
    expected: &[(SyntaxExpressionKind, &str)],
) {
    let statements = body.statement_payloads();
    let actual = statements
        ...
        .flat_map(|statement| {
            statement
                .syntax_statement()
                .and_then(|syntax| syntax.as_expr())
...
fn assert_cst_assignment_value_if_body_payloads(
    body: &body_payloads::CompilerBodyPayload<'_>,
    expected_then: &[Vec<(SyntaxStatementKind, &str)>],
    expected_else: &[Vec<(SyntaxStatementKind, &str)>],
) {
...
fn assert_cst_assignment_value_match_arm_body_payloads(
    body: &body_payloads::CompilerBodyPayload<'_>,
    expected: &[Vec<(SyntaxStatementKind, &str)>],
) {
    let statements = body.statement_payloads();
...
fn assert_cst_call_argument_block_body_payloads(
    body: &body_payloads::CompilerBodyPayload<'_>,
    expected: &[Vec<(SyntaxStatementKind, &str)>],
) {
    let statements = body.statement_payloads();
...
fn assert_cst_call_argument_if_body_payloads(
    body: &body_payloads::CompilerBodyPayload<'_>,
    expected_then: &[Vec<(SyntaxStatementKind, &str)>],
    expected_else: &[Vec<(SyntaxStatementKind, &str)>],
) {
...
fn assert_cst_call_argument_match_arm_body_payloads(
    body: &body_payloads::CompilerBodyPayload<'_>,
    expected: &[Vec<(SyntaxStatementKind, &str)>],
) {
    let statements = body.statement_payloads();
...
fn assert_cst_let_initializer_array_element_body_payloads(
    body: &body_payloads::CompilerBodyPayload<'_>,
...
fn assert_cst_assignment_value_array_element_body_payloads(
    body: &body_payloads::CompilerBodyPayload<'_>,
    expected_block: &[Vec<(SyntaxStatementKind, &str)>],
) {
    let statements = body.statement_payloads();
...
fn assert_cst_return_value_array_element_body_payloads(
    body: &body_payloads::CompilerBodyPayload<'_>,
    expected_block: &[Vec<(SyntaxStatementKind, &str)>],
) {
    let statements = body.statement_payloads();
...
fn assert_cst_call_argument_array_element_body_payloads(
    body: &body_payloads::CompilerBodyPayload<'_>,
    expected_block: &[Vec<(SyntaxStatementKind, &str)>],
) {
    let statements = body.statement_payloads();
