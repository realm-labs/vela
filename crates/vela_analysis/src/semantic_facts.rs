...
fn fallthrough_flow() -> ControlFlowFact {
    ControlFlowFact {
...
fn statement_flow(body: &HirBody, statement: &HirStmtKind) -> ControlFlowFact {
    match statement {
...
fn block_flow(body: &HirBody, block: HirBlockId) -> ControlFlowFact {
...
fn if_flow(body: &HirBody, value: &vela_hir::body::HirIf) -> ControlFlowFact {
    let then_flow = value
        .then_block
...
fn match_flow(body: &HirBody, value: &vela_hir::body::HirMatch) -> ControlFlowFact {
