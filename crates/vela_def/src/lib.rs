...
pub use script::{
    ...
    script_inherent_method_id, script_state_id, script_state_initializer_id, script_state_path,
    script_trait_id, script_trait_method_id, script_type_id, script_type_path, script_variant_id,
    script_variant_path,
};
pub use stable::stable_id;

#[must_use]
pub const fn host_release_function_id() -> FunctionId {
