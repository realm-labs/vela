use crate::workload_sources::{
    ...
    OPTION_RESULT_HELPERS_SOURCE, OPTION_RESULT_PREDICATES_SOURCE, RANGE_METHODS_SOURCE,
...
"#,
    ...
    Workload {
        name: "managed_heap_range_methods",
...
"#,
    ...
    Workload {
        name: "managed_heap_array_callback_predicates",
        mode: ExecutionMode::ManagedHeap,
