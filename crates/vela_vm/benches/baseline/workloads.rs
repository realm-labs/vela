use crate::workload_sources::{
    ...
    ARRAY_GROUP_BY_SOURCE, ARRAY_JOIN_SOURCE, ARRAY_LOOKUP_SOURCE, ARRAY_REVERSE_SOURCE,
    ARRAY_SLICE_SOURCE, ARRAY_SORT_SOURCE, ARRAY_SUM_SOURCE, BYTES_METHODS_SOURCE,
    CALLBACK_COLLECTIONS_SOURCE, DIRECT_CLOSURE_CALLS_SOURCE, HOST_DYNAMIC_KEY_ACCESS_SOURCE,
    HOST_FIELD_READ_WRITE_SOURCE, HOST_METHOD_CALLS_SOURCE, HOST_NESTED_READ_WRITE_SOURCE,
    HOST_RMW_MUTATION_SOURCE, MAP_CALLBACKS_SOURCE, MAP_EXTEND_SOURCE, MAP_FIND_ENTRIES_SOURCE,
    MAP_LOOKUP_SOURCE, MAP_MERGE_SOURCE, MAP_MUTATION_SOURCE, MAP_VIEWS_SOURCE,
    METHOD_DISPATCH_SOURCE, NATIVE_CALL_WIDE_ARGS_SOURCE, OPTION_RESULT_HELPERS_SOURCE,
    RECORD_QUADS_SOURCE, RECORD_QUINTS_SOURCE, RECORD_SEXTETS_SOURCE, RECORD_TRIPLETS_SOURCE,
    SCRIPT_CALL_SMALL_ARGS_SOURCE, SCRIPT_METHOD_DISPATCH_SOURCE, SET_COMBINATION_SOURCE,
