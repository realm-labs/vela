use crate::workload_sources::{
    ...
    BYTES_ACCESS_SOURCE, BYTES_METHODS_SOURCE, CALLBACK_COLLECTIONS_SOURCE,
    ...
    MAP_MERGE_SOURCE, MAP_MUTATION_SOURCE, MAP_VIEWS_SOURCE, METHOD_DISPATCH_SOURCE,
    NATIVE_CALL_WIDE_ARGS_SOURCE, OPTION_RESULT_HELPERS_SOURCE, RECORD_QUADS_SOURCE,
