...
use crate::{ExecutionBudget, HeapExecution, Value, VmError, VmErrorKind, VmResult, array_methods};

pub(crate) struct ScriptMethodDispatch<'a, 'heap> {
...
pub(crate) fn call_method_id(
    ...
    method_id: MethodId,
    args: &[Value],
    mut dispatch: ScriptMethodDispatch<'_, '_>,
) -> VmResult<Value> {
...
fn contextual_array_method_by_id(
    ...
    method_id: MethodId,
    args: &[Value],
    dispatch: &mut ScriptMethodDispatch<'_, '_>,
