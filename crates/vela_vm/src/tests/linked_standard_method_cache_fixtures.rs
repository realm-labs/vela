...
pub(super) use array::{
    ...
    linked_array_index_of_cache_program, linked_array_insert_cache_program,
    linked_array_is_empty_cache_program, linked_array_join_cache_program,
    linked_array_last_cache_program, linked_array_max_cache_program,
    linked_array_min_cache_program, linked_array_pop_cache_program,
