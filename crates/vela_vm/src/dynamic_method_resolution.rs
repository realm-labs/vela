...
fn string_method_id(ids: &StdMethodIds, method: &str) -> Option<MethodId> {
    Some(match method {
        ...
        "parse_i8" => ids.string_parse_i8,
        "parse_i16" => ids.string_parse_i16,
        "parse_i32" => ids.string_parse_i32,
        "parse_i64" => ids.string_parse_i64,
        "parse_u8" => ids.string_parse_u8,
        "parse_u16" => ids.string_parse_u16,
        "parse_u32" => ids.string_parse_u32,
        "parse_u64" => ids.string_parse_u64,
        "parse_f32" => ids.string_parse_f32,
        "parse_f64" => ids.string_parse_f64,
        "parse_bool" => ids.string_parse_bool,
        "parse_char" => ids.string_parse_char,
