...
) -> Result<std::sync::Arc<vela_bytecode::LinkedArtifact>, Box<dyn std::error::Error>> {
...
fn opcode_label(kind: &InstructionKind) -> &'static str {
    match kind {
        ...
        InstructionKind::MakeTuple { .. } => "MakeTuple",
        ...
        InstructionKind::GetRecordField { .. } => "GetRecordField",
        InstructionKind::GetRecordSlot { .. } => "GetRecordSlot",
        InstructionKind::SetRecordField { .. } => "SetRecordField",
        InstructionKind::SetRecordSlot { .. } => "SetRecordSlot",
        InstructionKind::GetEnumField { .. } => "GetEnumField",
        InstructionKind::GetEnumSlot { .. } => "GetEnumSlot",
        InstructionKind::TupleArityEqual { .. } => "TupleArityEqual",
        InstructionKind::GuardTupleArity { .. } => "GuardTupleArity",
        InstructionKind::GetTupleField { .. } => "GetTupleField",
        ...
        InstructionKind::LoadState { .. } => "LoadState",
        InstructionKind::StoreState { .. } => "StoreState",
        InstructionKind::LoadExternState { .. } => "LoadExternState",
        ...
        InstructionKind::TryReleaseBorrowLease { .. } => "TryReleaseBorrowLease",
