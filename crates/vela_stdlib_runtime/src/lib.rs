...
impl StdFunctionImplementation {
    ...
    pub const fn from_manifest_path(module: &str, name: &str) -> Option<Self> {
        match (module.as_bytes(), name.as_bytes()) {
            ...
            (b"i32", b"from_i16") => Some(Self::I32FromI16),
            (b"i64", b"from_i32") => Some(Self::I64FromI32),
            (b"u32", b"from_u16") => Some(Self::U32FromU16),
            (b"u64", b"from_u32") => Some(Self::U64FromU32),
            (b"f64", b"from_f32") => Some(Self::F64FromF32),
            (b"i32", b"try_from_i64") => Some(Self::I32TryFromI64),
            (b"i16", b"try_from_i64") => Some(Self::I16TryFromI64),
            (b"i8", b"try_from_i64") => Some(Self::I8TryFromI64),
            (b"u16", b"try_from_u64") => Some(Self::U16TryFromU64),
