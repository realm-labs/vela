...
no executable body; their defaults use the canonical analysis-only roots reviewed
in [S2](completion-s2.md), including nested lexical bindings and shared shadow
checks. No runtime body or language semantics are added.

Nested lexical bodies inside required trait defaults are covered by the separate
S2/body review. This declaration review does not certify S7, generated
combinations, scale, UX04 or fresh macOS execution. B03
