...
This chapter belongs to **Methods And Dispatch**.

## Goals

TODO: document the semantics, examples, host boundary behavior, and common errors for Standard Library Methods.
