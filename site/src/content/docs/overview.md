...
The language is dynamic, but its embedding boundary is explicit. Hosts choose which types, fields, methods, native functions, extern state, capabilities, and budgets are available to each runtime.
